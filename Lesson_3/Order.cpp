...
//declare the function else change the order
...
for example. The ifndef checks if HEADER_EXAMPLE_H has not been defined in the file already. If it has not been defined yet,
